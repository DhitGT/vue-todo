  ...
  <div class="flex">
    ...
    >
      ...
      <p class="font-normal text-gray-700 dark:text-gray-400">
        Welcome to the ultimate to-do list experience! A to-do list is a
        powerful tool designed to help you organize, prioritize, and manage your
        tasks efficiently. Whether you're a student, a professional, or someone
        juggling multiple responsibilities, our to-do list application is here
